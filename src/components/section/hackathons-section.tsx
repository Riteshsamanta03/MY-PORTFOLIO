        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Participating in hackathons has been a transformative learning experience for me as a Computer Science student. They challenge me to understand real-world problems quickly, think creatively, and turn ideas into working solutions within limited time. Hackathons have strengthened my teamwork, problem-solving, and decision-making skills while pushing me to learn new technologies on the fly.
            </p>
          </div>
        </div>
        <Timeline>
